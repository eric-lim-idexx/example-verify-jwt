...
Issuer: https://cognito-idp.us-east-1.amazonaws.com/us-east-1_MYwLjVmE0
Subject: 34072pj40g3s6gur09gpesircj
Expiry: 1756267694
Scope: http://localhost:7357/v1/test/read http://localhost:7357/v1/test/write

Is token signature valid? true
Is token payload valid? true
Is token authorized? true
```
